...
public class LessonCreator2 {
    public static void main(String argv[]) throws IOException {
        ...
        String next = "lessons/Lesson-3.lsn";
        // Create level 1
        Lesson l1 = new Lesson("Finding Water", strs, pos, "water", images, next);

        // Save level 1
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/lessons/Lesson-2.lsn"));
        out.writeObject(l1);
        out.close();
    }
}
