...
public class LessonCreator1 {
    public static void main(String argv[]) throws IOException {
        ...
        String next = "lessons/Lesson-2.lsn";
        // Create level 1
        Lesson l1 = new Lesson("Navigation", strs, pos, "map", images, next);

        // Save level 1
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/lessons/Lesson-1.lsn"));
        out.writeObject(l1);
        out.close();
    }
}
