...
public class LessonCreator3 {
    public static void main(String argv[]) throws IOException {
        ...
        String next = "lessons/Lesson-4.lsn";
        // Create level 1
        Lesson l1 = new Lesson("Foraging", strs, pos, "apples", images, next);

        // Save level 1
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/lessons/Lesson-3.lsn"));
        out.writeObject(l1);
        out.close();
    }
}
