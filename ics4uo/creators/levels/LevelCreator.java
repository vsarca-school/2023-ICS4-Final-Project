...
import timbertrek.drivers.Question;
...
//         out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Level-1.lvl"));
//         out.writeObject(l);
//         out.close();
//
//
...
//         px = 5;
//         py = 5;
//         next = "levels/Level-3.lvl";
//
//         // Save level 2
//         scene = 1; // cave
//         wolves = new int[][]{{8,1}, {7,2}, {0, 0}};
//         l = new Level(ground, objects, px, py, next, scene, wolves, null);
//         out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Level-2.lvl"));
//         out.writeObject(l);
//         out.close();
//
//         // Level 3
...
//
//         next = "levels/Level-4.lvl";
//         // Save level 2
//         scene = 0; // cave
//         wolves = new int[][]{{2,0}, {5,2}, {9, 1}, {15, 0}};
//         l = new Level(ground, objects, 0, 0, next, scene, wolves, null);
//         out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Level-3.lvl"));
//         out.writeObject(l);
//         out.close();
//
//         // Level 4
...
//
//         next = "levels/Level-5.lvl";
//         // Save level 2
//         scene = 1; // cave
//         wolves = new int[][]{{2,0}, {14, 15}, {16, 15}, {15, 14}, {15, 16}};
//         l = new Level(ground, objects, 0, 0, next, scene, wolves, null);
//         out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Level-4.lvl"));
//         out.writeObject(l);
//         out.close();
//
//        // Level 5
...
//        l = new Level(ground, objects, 20, 20, null, scene, wolves, null);
//        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Level-5.lvl"));
//        out.writeObject(l);
//        out.close();
    }
}
