...
public class MazeCreator {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Maze-1.lvl"));
        out.writeObject(l);
        out.close();
        ...
        px = 3;
        py = 2;
        next = "levels/Maze-3.lvl";
        scene = 0;
        questions = new Question[1];
        questions[0] = new Question("What is a good source of water?", new String[]{"Lakes", "Rain", "Oceans", "Runoff water"}, 1, 8, 8);
        // Save level 1
        l = new Level(ground, objects, px, py, next, scene, new int[0][0], questions);
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Maze-2.lvl"));
        out.writeObject(l);
        out.close();
        ...
        // Save level 1
        l = new Level(ground, objects, px, py, next, scene, new int[0][0], questions);
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Maze-3.lvl"));
        out.writeObject(l);
        out.close();
        ...
        // Save level 1
        l = new Level(ground, objects, px, py, next, scene, new int[0][0], questions);
        out = new ObjectOutputStream(new FileOutputStream("C:/Users/Felix/IdeaProjects/ics4uo/ics4uo/src/main/resources/levels/Maze-4.lvl"));
        out.writeObject(l);
        out.close();
    }
}
